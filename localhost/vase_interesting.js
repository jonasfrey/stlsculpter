function() {
    ...
    function f_a_o_p(
        ...
        let a_o = new Array(n_corners).fill(0).map((v, n_idx) => {
            ...
            n_amp += Math.sin(n_it_layer_nor*0.96*n_tau)*n_radius_base*.5;
            let n_rad_offset = 0;
            ...
            let n1 = Math.sin(n_it_layer_nor*n_tau*12.)*.11;
            o_trn1.n_x += Math.sin(n1*n_tau+n_it_nor_corner*n_tau*n_corners/10.)*2;
            o_trn1.n_y += Math.cos(n1*n_tau+n_it_nor_corner*n_tau*n_corners/10)*2;
