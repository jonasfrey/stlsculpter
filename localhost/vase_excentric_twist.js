function() {
            ...
            function f_a_o_p(
                ...
                let a_o = new Array(n_corners).fill(0).map((v, n_idx) => {
                    ...
                    let n2 = Math.pow(n_it_layer_nor-.5,2.)*-1+0.3;
                    let n_amp = n_radius_base+n2*100.;
                    let n_rad_offset = 0//n_it_layer_nor*n_tau*(1./5./2.);
                    let n_amp2 = 3;
                    let o_trn2 = f_o_vec(
                        Math.sin(n_it_layer_nor*n_tau*3.)*n_amp2,
                        Math.cos(n_it_layer_nor*n_tau*3.)*n_amp2,
                        0
                    );
