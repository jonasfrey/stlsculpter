...
let f_n_linio = function(n_x){
    ...
    function f_a_o_p(
        ...
        let a_o = new Array(n_corners).fill(0).map((v, n_idx) => {
            ...
            let n_pc2 = n_pc1+1;
            let n_it_nor_corner_mirrored = Math.abs(((n_it_nor_corner+.25)%1)-.5);
            let o_trn1 =  f_o_p_on_polygon(n_it_nor_corner_mirrored,n_pc1, n_amp, n_rad_offset);
            let o_trn2 =  f_o_p_on_polygon(n_it_nor_corner_mirrored,n_pc2, n_amp, n_rad_offset);
